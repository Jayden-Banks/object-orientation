...
let kitty = new Cat('Hamilton', 4, 'Brown')
...
let Wizard1 = new Wizard('Jake', 10, 'Sleep')
//Wizard1.castSpell()
...
//let phone1 = new Phone('Samsung', 'Galaxy', '64 gigs', 'Black', '$799.00')
//phone1.sell()
//phone1.changePrice('$650.00')
//console.log(phone1)
...
//Code Here
let phone1 = new Phone('Samsung', 'Galaxy', '64 gigs', 'Black', '$799.00')
let phone2 = new Phone('Apple', 'iPhone', '32 gigs', 'White', '$1000.00')
let phone3 = new Phone('Google', 'Pixel', '128 gigs', 'Yellow', '$350.00') 
...
//Code Here
let myFirstVehicle = new Vehicle(100,'White', 5000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(50,'Black',100, 'Harley', true)
//console.log(myFirstMotorcycle)
//myFirstMotorcycle.move(100)
//onsole.log(myFirstMotorcycle)
/*
...
//Code Here
let myFirstBoat = new Boat(500, 'Orange', 2000, 'Eureka', 'Yacht', false)
